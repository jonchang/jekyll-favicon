    ...
    module Resource
      ...
      class Browserconfig
        ...
        def add_browserconfig_elements(config, prefix)
          ...
          add path, 'square70x70logo', 'src' => pn.join('favicon-128x128.png')
          add path, 'square150x150logo', 'src' => pn.join('favicon-270x270.png')
          add path, 'wide310x150logo', 'src' => pn.join('favicon-558x270.png')
          add path, 'square310x310logo', 'src' => pn.join('favicon-558x558.png')
